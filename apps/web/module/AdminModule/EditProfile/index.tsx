...
const Index = () => {
  ...
  const { data, isPending, refetch } = useGetBackOfficerInfo(backOfficerId);
  ...
  const { mutateAsync: removeProfilePicture } =
    useDeleteBackOfficerProfilePicture(photoId);
        ...
        <div className="relative z-10 w-full max-w-full h-[90vh] bg-primary bg-opacity-50 shadow-2xl rounded-xl flex flex-col justify-center items-center p-6 sm:p-10 md:p-12 lg:p-14">
          <div className="flex justify-center text-center">
            {isPending ? (
              ...
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-10 md:p-8 w-full md:max-w-[550px] lg:max-w-full">
                <Typography
                  variant="h2"
