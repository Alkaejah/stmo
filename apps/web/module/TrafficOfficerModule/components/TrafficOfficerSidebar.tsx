...
type TrafficOfficerSidebarProps = {
  children: React.ReactNode;
};

const TrafficOfficerSidebar = ({ children }: TrafficOfficerSidebarProps) => {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div
        ...
        } bg-primary text-white flex flex-col p-4 transition-all duration-300 ease-in-out h-full overflow-y-auto`}
      >
        {/* Toggle Button */}
        <div
        ...
        >
          {profilePictureUrl ? (
            <Image
              ...
              className={`rounded-full object-cover aspect-square bg-gray- border-white-500 ${
        ...
        <div className="flex flex-col gap-6 w-full overflow-y-auto">
          ...
          >
            ...
            {isSidebarOpen && (
              <Link href="/officer/dashboard" className="hover:text-gray-300">
                Dashboard
              </Link>
            )}
          </button>
            ...
            >
              {isSidebarOpen && (
                <div className="ml-12 mt-2 flex flex-col gap-2 text-sm">
                  <Link
                    href="/officer/edit-profile"
                    className="hover:text-gray-300"
                  >
                    Personal Information
                  </Link>
                  <Link
                    href="/officer/edit-password"
                    className="hover:text-gray-300"
                  >
                    Password
                  </Link>
          ...
          >
            <LucideUserRoundPlus className="w-6 h-6 items-center" />
            {isSidebarOpen && (
              <Link
                href="/officer/create-drivers-account"
                className="hover:text-gray-300"
              >
          ...
          >
            <LucideTicketPlus className="w-6 h-6 items-center" />
            {isSidebarOpen && (
              <Link
                href="/officer/add-violation-ticket"
                className="hover:text-gray-300"
              >
                Add Violation Ticket
              </Link>
            )}
          </button>
          <button
          ...
          >
            <LucideHistory className="w-6 h-6 items-center" />
            {isSidebarOpen && (
              <Link
                href="/officer/ticket-history"
                className="hover:text-gray-300"
              >
                Ticket History
              </Link>
...
export default TrafficOfficerSidebar;
