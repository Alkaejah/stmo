...
import useBackOfficerVerifyForgotPassword from "@/common/hooks/BackOffice/useBackOfficerVerifyForgotPassword";
...
const OfficerResetPassword = () => {
  ...
  const { mutate: resetPassword, isPending: isPendingReset } =
    useBackOfficerVerifyForgotPassword();
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onSubmit = (formData: IResetPassword) => {
    ...
    resetPassword(
      {
        backOfficerControlNumber: controlNumber as string,
