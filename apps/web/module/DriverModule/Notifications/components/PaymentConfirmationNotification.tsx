...
const PaymentConfirmationNotification = () => {
  ...
  const rawNotificationId = params.selectedNotificationId; //used selectedNotification because it is the URL key passed from the index page
            ...
            <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-xl flex flex-col justify-between h-auto">
              ...
              <Typography>
                ...
                <span className="font-bold text-secondary">
                  {paymentConfirmationData.name}
                </span>
              </Typography>
              <Typography className="my-2">
                We are pleased to confirm that your payment for the violation
                ...
                <ul>
                  <li>
                    <Typography>
                      Ticket Number:{" "}
                      <span className="font-bold text-secondary">
                        {paymentConfirmationData.ticketNumber || "N/A"}
                      </span>
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      Date of Violation:{" "}
                      <span className="font-bold text-secondary">
                        {paymentConfirmationData.violationDate}
                      </span>
                    </Typography>
                  </li>
                  <li>
                    <Typography>
                      Location:{" "}
                      <span className="font-bold text-secondary">
                        {paymentConfirmationData.location}
                      </span>
                    </Typography>
                  </li>
                  <Typography>
                    ...
                    <span className="font-bold text-secondary">
                      ₱
                      {paymentConfirmationData.totalPenalty.toLocaleString(
                        "en-US",
              ...
              <Typography className="my-2">
                This notification serves as an official receipt for your
                records. Thank you for resolving this matter promptly.
              </Typography>
