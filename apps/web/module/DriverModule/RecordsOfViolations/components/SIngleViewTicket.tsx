...
import useGetViolationRecordById from "@/common/hooks/Drivers/module/useGetViolationRecordById";
import { format, parseISO } from "date-fns";
import { LucideArrowLeft } from "lucide-react";

const SingleViewTicket = () => {
  const param = useParams<{ recordId: string }>();
  const recordId = param.recordId;
  const { data } = useGetViolationRecordById(recordId);
...
export default SingleViewTicket;
